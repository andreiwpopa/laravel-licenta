                    ...
                    @if($departament->facultate_id == $facultate->id)
                        ...
                        <div class="rounded-lg border dark:border-gray-700 bg-card text-card-foreground shadow-2xl" data-v0-t="card">
                            <form method="POST" action=" {{ route('admin.students.completeaza') }}">
                                ...
                                <div class="p-6">
                                    <div class="text-2xl font-bold dark:text-gray-200"> {{$this->countStudentiInscrisi($facultate->id,$departament->id)}} /
                                    ...
                                    <div class="text-2xl font-bold dark:text-gray-200">{{$this->countStudentiAdmisi($facultate->id,$departament->id)}}</div>
