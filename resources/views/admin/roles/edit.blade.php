                ...
                <div class="mt-6 p-2 bg-slate-100">
                    ...
                    <div class="flex space-x-2 mt-4 p-2">
                        @if($role->permissions)
                            ...
                            <form method="POST" class="font-medium px-4 py-2 bg-red-500 hover:bg-red-700 text-white rounded-md hover:underline" action=" {{route('admin.roles.permissions.revoke', [$role->id, $role_permission->id]) }}" onsubmit="return confirm('Are you sure?');">
                                @csrf
                                @method('DELETE')
